...
//        indxPg.clickSignInButton();
//        Thread.sleep(2000);
//
//        MyAccountPage myAccountPage = new MyAccountPage(driver);
//        myAccountPage.setRegisteredEmail(DefaultUsername);
//        myAccountPage.setRegisteredPassword(DefaultPassword);
//        myAccountPage.clickSubmitLogin();
//
